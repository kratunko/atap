...
if __name__ == '__main__':
    corpus = PickledCorpusReader('/Users/dd/PycharmProjects/atap/resources/sample/')
    G = graph(corpus)
    ...
    plt.show()
    plt.savefig("/Users/dd/PycharmProjects/atap/resources/atap_ch09_hollywood_entity_graph.png", transparent=True)
